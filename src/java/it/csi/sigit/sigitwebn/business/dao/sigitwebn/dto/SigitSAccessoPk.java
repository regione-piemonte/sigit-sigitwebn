...
/**
 * Primary Key del DTO SigitSAccessoDto.
 * E' utilizzato per tutte le operazioni di lettura dati per chiave primaria. 
 * @generated
 */
public class SigitSAccessoPk implements Serializable {
	...
	/**
	 * Method 'equals'. 
	 * Due istanze di SigitSAccessoPk sono equals se i valori di tutti i campi coincidono.
	 * 
	 * @param _other
	...
	public boolean equals(Object _other) {
		...
		if (!(_other instanceof SigitSAccessoPk)) {
			return false;
		}

		final SigitSAccessoPk _cast = (SigitSAccessoPk) _other;
	...
	public String toString() {
		...
		ret.append("it.csi.sigit.sigitwebn.business.dao.sigitwebn.dto.SigitSAccessoPk: ");
