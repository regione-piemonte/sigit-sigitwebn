...
public class CPBECpGestReeTipo1 {
	...
	public ExecResults salvaRee(
		...
		try {
			...
			try {
				...
				/*
				getValidationMgr().validazioneFormaleReeTipo1(tipo1,
						theModel.getAppDataidentificativoImpianto().getCodiceImpianto(),
						dettaglioAllegato.getDataControllo());
				*/

				getDbMgr().salvaReeTipo1(tipo1, dettaglioAllegato,
	...
	public ExecResults caricaReeTipo1(
		...
		/// definizione costanti di outcome
		final String CARICAREETIPO1_OUTCOME_CODE__OK = //NOSONAR  Reason:EIAS
				"OK"; //NOSONAR  Reason:EIAS
		///
		try {
			ExecResults result = new ExecResults();
			...
			// impostazione del result code 
			result.setResultCode(CARICAREETIPO1_OUTCOME_CODE__OK);
	...
	public ExecResults caricaMenuTipo1(
		...
		try {
			...
			if (theModel.getAppDatareeMenuTree() == null) {
				...
				TreeNodeBase libNode = new TreeNodeBase(librettoNodeId, "REE Rapporto di Efficienza Energetica Tipo 1",
						false);
